...
const ABOUT_MARKS = [
  { icon: "solar:users-group-rounded-bold", top: "16%", side: "right", offset: "8%", size: 62, rotate: "-10deg" },
  { icon: "solar:medal-ribbons-star-bold", top: "40%", side: "right", offset: "18%", size: 56, rotate: "8deg" },
  { icon: "solar:hand-shake-bold", top: "70%", side: "right", offset: "10%", size: 60, rotate: "12deg" },
  { icon: "solar:document-text-bold", top: "20%", side: "left", offset: "8%", size: 60, rotate: "10deg" },
  { icon: "solar:target-bold", top: "52%", side: "left", offset: "16%", size: 54, rotate: "0deg" },
  { icon: "solar:heart-pulse-bold", top: "76%", side: "left", offset: "10%", size: 64, rotate: "-10deg" },
] as const;
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-3xl text-center">
        ...
        <p className="text-base md:text-lg leading-relaxed text-slate-600 max-w-2xl mx-auto mb-8">
          منصة أكاديمية احترافية تمكّن الطلاب من إنجاز أعمالهم بثقة، وفق أعلى المعايير الجامعية.       </p>

        <div className="flex flex-wrap justify-center gap-3">
          {[
            { icon: "solar:users-group-rounded-bold", label: "فريق متخصص" },
            { icon: "solar:medal-ribbons-star-bold", label: "جودة عالية" },
            { icon: "solar:hand-shake-bold", label: "ثقة وموثوقية" },
          ].map((item, i) => (
            <div
              key={i}

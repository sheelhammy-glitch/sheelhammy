...
const PAYMENT_MARKS = [
  ...
  { icon: "solar:card-bold", top: "16%", side: "right", offset: "8%", size: 62, rotate: "-10deg" },
  { icon: "solar:transfer-horizontal-bold", top: "40%", side: "right", offset: "18%", size: 56, rotate: "8deg" },
  { icon: "solar:banknote-2-bold", top: "70%", side: "right", offset: "10%", size: 60, rotate: "12deg" },
 
  { icon: "solar:wallet-money-bold", top: "20%", side: "left", offset: "8%", size: 60, rotate: "10deg" },
  { icon: "solar:qr-code-bold", top: "52%", side: "left", offset: "16%", size: 54, rotate: "0deg" },
  { icon: "solar:bank-bold", top: "76%", side: "left", offset: "10%", size: 64, rotate: "-10deg" },
] as const;
  ...
  <Icon icon="solar:card-bold" width={12} className="text-[#0056D2]" />
    ...
    <span> طرق الدفع</span>
        ...
        <p className="text-base md:text-lg leading-relaxed text-slate-600 max-w-2xl mx-auto mb-8">
          نوفر خيارات دفع متعددة محلية وعالمية لتجربة دفع آمنة وسلسة عند طلب خدماتنا الأكاديمية .
        </p>

...
export async function generateMetadata(): Promise<Metadata> {
  return generateSEOMetadata({
    ...
    description: "الصفحة التي تبحث عنها غير موجودة. ارجع إلى الصفحة الرئيسية أو استكشف خدماتنا الأكاديمية.",
    noindex: true,
  });
}
...
export default function NotFoundPage() {
  return (
    <main dir="rtl" className="min-h-screen mt-20 flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-white via-blue-50/30 to-white">
